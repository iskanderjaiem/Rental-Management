...
/* svplocationAdminBundle:Materiel:louer1.html.twig */
class __TwigTemplate_fd284032ccf3e7fab96d6901c2e7a83c7d9ae54cae865c3dd7a6d85e00b23780 extends Twig_Template
{
    ...
    <script>
        ...
        function next() {
            var route = \"";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("location_materiel_2", array("idClient" => (isset($context["idClient"]) ? $context["idClient"] : $this->getContext($context, "idClient")), "idEntrep" => "1")), "html", null, true);
        echo "\";
...
";
    ...
    {
        return "svplocationAdminBundle:Materiel:louer1.html.twig";
    }
