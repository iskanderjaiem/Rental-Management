...
/* svplocationAdminBundle:Materiel:louer2.html.twig */
class __TwigTemplate_51414acb7f960fe41a1715a0f5753e2c8bc9bd37e5c41a37a31622c0495a99d0 extends Twig_Template
{
    ...
    <script>
        ...
        \$('#rent_btn').click(function () {
            ...
            if ((Number.isInteger(parseInt(\$nb))) && (\$nb > 0)) {
                \$('#table').show();
                \$('#id_mat').text(\$('#materiels').val());
                \$('#cat_mat').text(\$('#materiels optgroup option').text());
...
";
    ...
    <div class=\"page-content-wrapper\">
        ...
        echo "\"> 
                    ...
                    <div class=\"portlet light form-fit bordered\">
                        ...
                        <div class=\"portlet-body form\">
                            ...
                            ";
        // line 166
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("location_materiel_2", array("idEntrep" => $this->getAttribute((isset($context["entrep"]) ? $context["entrep"] : $this->getContext($context, "entrep")), "idEntrepot", array()), "idClient" => (isset($context["idClient"]) ? $context["idClient"] : $this->getContext($context, "idClient")))), "id" => "myForm", "method" => "POST", "onsubmit" => "return next();"));
        echo "
        ...
        echo "</label>
                                    ...
                                    <div class=\" control-label col-md-3\"> 
                                        <select id=\"materiels\" class=\"form-control select2 select2-hidden-accessible\" tabindex=\"-1\" aria-hidden=\"true\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["materiel"]) {
            // line 180
            echo "                                                    <option  value=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($context["materiel"], "idMateriel", array()), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute($context["materiel"], "nom", array()), "html", null, true);
            echo "-";
            echo twig_escape_filter($this->env, trim(twig_slice($this->env, $this->getAttribute($context["materiel"], "idCategorie", array()), 0, 20)), "html", null, true);
            echo "</option>                                            
                                                ";
        }
                                    ...
                                    <div hidden id=\"table\" class=\"table-editable\">
                                        <table class=\"table\">
                                            ...
                                            <tr>
                                                <th>Id materiel</th>";
        // line 204
        echo "                                                <th>Nom materiel - Reference</th>
                                                <th>Quantité</th>";
        // line 206
        echo "                                                <th></th>
                                                <th></th>
                                            ...
                                            <tr class=\"hide\">
                                                <td id=\"id_mat\">undefined</td>
                                                <td id=\"cat_mat\">undefined</td>
...
";
    ...
    {
        return "svplocationAdminBundle:Materiel:louer2.html.twig";
    }
    ...
    {
        return array (  458 => 279,  451 => 275,  447 => 274,  443 => 273,  437 => 270,  431 => 267,  425 => 264,  421 => 263,  417 => 262,  411 => 259,  407 => 258,  403 => 257,  399 => 256,  395 => 255,  391 => 254,  387 => 253,  383 => 251,  380 => 250,  364 => 236,  360 => 235,  356 => 234,  342 => 223,  323 => 206,  320 => 204,  297 => 182,  284 => 180,  280 => 179,  269 => 171,  261 => 166,  220 => 128,  188 => 98,  185 => 97,  176 => 91,  166 => 84,  162 => 83,  155 => 79,  151 => 78,  147 => 77,  141 => 74,  137 => 73,  131 => 70,  127 => 69,  123 => 68,  119 => 67,  113 => 64,  109 => 63,  105 => 62,  101 => 61,  89 => 51,  86 => 50,  44 => 11,  37 => 7,  34 => 6,  31 => 5,);
    }
}
